...
library(knitr)
library(kableExtra)
simple_codebook <- read_csv("simple_codebook.csv")
```
# Describing the data
The following table describes all variables of the data for both standard 
deviation and mean of the tidy data.
```{r}
kable(simple_codebook, digits = 2, format = "html") %>%
  kable_styling(bootstrap_options = c("striped", "hover"),
        ...
        column_spec(column = 7, width = "3cm", bold = TRUE)

```

# Production of the tidy data
The tidy data was produced by first importing the complete set of test and
training data. 

The data was then merged into one complete table based on subject and activity 
ID for each reading. Features and activity labels were included. The six 
activities were as follows: 
        ...
        5. STANDING
        6. LAYING
Using grepl the means and std columns were identified and subset into a seperate
data.frame for *tidy* presentation and final output. 
